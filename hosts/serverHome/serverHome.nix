...

{
  ...
  systemd.services.portfolio-image-sync = {
    ...
    script = ''
      ...
      rsync -a --include="*/" --include="*.jpg" --include="*.jpeg" --include="*.png" --include="*.webp" --include="*.JPG" --include="*.PNG" --include="*.WEBP" --include="*.gif" --include="*.GIF" --include="*.mp4" --include="*.MP4" --include="*.svg" --exclude="*" "$NC_DIR/" "$WEB_DIR/"
